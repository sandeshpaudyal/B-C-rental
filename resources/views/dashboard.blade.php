    ...
    <div class = "row">
       ...
       <div class = "col-md-4">                    
          <nav id="sidebar">
            ...
            <ul class="nav nav-tabs list-unstyled components" id="myTab" role="tablist" style="display: inline-block;">
                <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="bike" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="card" style="padding:20px;">
                            <div class="top">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link ser-link" href="{{ route('cars') }}"><i class="fas fa-motorcycle"></i>&nbsp; Add Bike  </a>
                                    </li>
                                </div>
                                <br><br>
                     ...
                     <input class="form-control" id="myInput" type="text" placeholder="Search..">
                        ...
                        <div class="tab-pane fade show " id="article" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="card" style="padding:20px;">
                                <div class="top">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link ser-link" href="{{ route('cars') }}"><i class="fas fa-newspaper"></i>&nbsp; Post an Article  </a>
                                        </li>
                                    </ul>
                                    </div>
                                    <br><br>
                                    <input type="text" class="form-control" placeholder="Title of the Article"><br>
                                    <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="Description"></textarea><br>
