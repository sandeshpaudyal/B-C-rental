...
<div class="container">
  <div class="card uper" style="margin:100px;">
    ...
    <div class="card-body" style="background:#f5f5f5;">
      ...
      @endif
        <form method="post" action="{{ route('cares.update', $cars->id) }}">
            <div class="form-group">
                @csrf
                <label for="name">Brand:</label>
                <input type="text" class="form-control" style="width:450px;" placeholder="Hyundai" name="brand" value={{ $cars->brand }}/>
            </div>
            <div class="form-group">
